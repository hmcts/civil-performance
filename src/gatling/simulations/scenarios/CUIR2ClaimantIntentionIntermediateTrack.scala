...
object CUIR2ClaimantIntentionIntermediateTrack {
  ...
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_240_TriedToSettle") {
        exec(http("CUIR2_ClaimantIntention_240_005_TriedToSettle")
          .get(CitizenURL + "/case/#{caseId}/directions-questionnaire/tried-to-settle")
  ...
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_260_TriedSettle") {
        exec(http("CUIR2_ClaimantIntention_260_005_ConfirmNumberTriedSettle")
          .post(CitizenURL + "/case/#{caseId}/directions-questionnaire/tried-to-settle")
      ...
      * Civil UI Claim - Request extra Time
      ...
      .group("CUIR2_ClaimantIntention_260_RequestExtraTime") {
        exec(http("CUIR2_ClaimantIntention_260_005_RequestExtraTime")
          .post(CitizenURL + "/case/#{caseId}/directions-questionnaire/request-extra-4-weeks")
          .headers(CivilDamagesHeader.CUIR2Post)
          .formParam("_csrf", "#{csrf}")
          .formParam("option", "no")
      ...
      * Civil UI Claim - Claim Documents
      ...
      .group("CUIR2_ClaimantIntention_260_ClaimantDocuments") {
        exec(http("CUIR2_ClaimantIntention_260_005_ClaimantDocuments")
          .post(CitizenURL + "/case/#{caseId}/directions-questionnaire/consider-claimant-documents")
          .headers(CivilDamagesHeader.CUIR2Post)
          .formParam("_csrf", "#{csrf}")
          .formParam("detail", "")
          .formParam("option", "no")
  ...
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_270_GiveDetails") {
        exec(http("CUIR2_ClaimantIntention_270_005_GiveDetails")
          .post(CitizenURL + "/case/#{caseId}/directions-questionnaire/expert-evidence")
          .headers(CivilDamagesHeader.CUIR2Post)
          .formParam("_csrf", "#{csrf}")
          .formParam("option", "no")
          .check(CsrfCheck.save)
  ...
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_300_GiveEvidence") {
        exec(http("CUIR2_ClaimantIntention_300_005_GiveEvidence")
  ...
  * Civil UI Claim - Do you have other witnesses? - no
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_310_OtherWitnesses") {
        exec(http("CUIR2_ClaimantIntention_310_005_OtherWitnesses")
  ...
  * Civil UI Claim - Are there any dates in the next 12 months when you, your experts or witnesses cannot go to a hearing? - no
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_320_AnyDates") {
        exec(http("CUIR2_ClaimantIntention_320_005_AnyDates")
  ...
  * Civil UI Claim - Do you want to ask for a telephone or video hearing? - yes
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_330_AskForTelephone") {
        exec(http("CUIR2_ClaimantIntention_330_005_AskForTelephone")
  ...
  * Civil UI Claim - Are you, your experts or witnesses vulnerable in a way that the court needs to consider? - no
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_340_Vulnerable") {
        exec(http("CUIR2_ClaimantIntention_340_005_Vulnerable")
  ...
  * Civil UI Claim - Do you, your experts or witnesses need support to attend a hearing? - no
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_350_NeedSupport") {
        exec(http("CUIR2_ClaimantIntention_350_005_NeedSupport")
  ...
  * Civil UI Claim - Do you want to ask for the hearing to be held at a specific court? - no
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_360_SpecifcCourt") {
        exec(http("CUIR2_ClaimantIntention_360_005_SpecifcCourt")
  ...
  * Civil UI Claim - Welsh language
  ==========================================================================================*/
      ...
      .group("CUIR2_ClaimantIntention_370_WelshLanguage") {
        exec(http("CUIR2_ClaimantIntention_370_005_WelshLanguage")
