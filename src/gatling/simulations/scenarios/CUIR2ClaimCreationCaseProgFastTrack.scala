...
object CUIR2ClaimCreationCaseProgFastTrack {
  ...
  // after english below steps are to be continued
    ...
    ==========================================================================================*/
      .group("CUIR2_Claimant_330_ClaimamountPost") {
        exec(http("CUIR2_Claimant_330_005_ClaimAmountPost")
          ...
          .formParam("claimAmountRows[0][amount]", "13000")
   ...
   .exec { session =>
         val fw = new BufferedWriter(new FileWriter("CUIClaimFTDetails.csv", true))
         try {
