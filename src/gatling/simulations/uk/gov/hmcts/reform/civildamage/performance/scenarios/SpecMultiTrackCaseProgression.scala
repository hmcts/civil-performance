...
object SpecMultiTrackCaseProgression {
 ...
 ==========================================================================================*/
  ...
  // feed(cpfulltestFeeder)
    exec(_.setAll(
      ...
      ==========================================================================================*/
      .group("CivilMT_HearingNotice_030_SearchCase") {
        exec(http("CivilMT_HearingNotice_030_SearchCase")
    ...
    ==========================================================================================*/
      .group("CivilMT_HearingNotice_040_ScheduleHearing") {
        exec(http("CivilMT_HearingNotice_040_005_ScheduleHearing")
          ...
          .exec(http("CivilMT_HearingNotice_040_010_ScheduleHearing")
          ...
          .exec(http("CivilMT_HearingNotice_040_015_ScheduleHearing")
            .get("/workallocation/case/tasks/#{caseId}/event/HEARING_SCHEDULED/caseType/CIVIL/jurisdiction/CIVIL")
            .headers(CivilDamagesHeader.MoneyClaimNav)
            .header("accept", "application/json")
            .check(substring("task_required_for_event"))
  ...
  ==========================================================================================*/
      .group("CivilMT_HearingNotice_050_WhatHearingNotice") {
        exec(http("CivilMT_HearingNotice_050_005_WhatHearingNotice")
          ...
          .body(ElFileBody("bodies/multitrackspec/WhatHearingNotice.json"))
 ...
 ==========================================================================================*/
      .group("CivilMT_HearingNotice_060_ListOrRelisting") {
        exec(http("CivilMT_HearingNotice_060_005_ListOrRelisting")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=HEARING_SCHEDULEDListingOrRelisting")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/ListOrRelisting.json"))
 ...
 ==========================================================================================*/
      .group("CivilMT_HearingNotice_070_HearingDetails") {
        exec(http("CivilMT_HearingNotice_070_005_HearingDetails")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=HEARING_SCHEDULEDHearingDetails")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/HearingDetails.json"))
 ...
 ==========================================================================================*/
      .group("CivilMT_HearingNotice_080_HearingExtraDetails") {
        exec(http("CivilMT_HearingNotice_080_005_HearingExtraDetails")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=HEARING_SCHEDULEDHearingInformation")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/HearingExtraDetails.json"))
 ...
 ==========================================================================================*/
      .group("CivilMT_HearingNotice_090_HearingScheduleSubmit") {
        exec(http("CivilMT_HearingNotice_090_005_HearingScheduleSubmit")
          .post(BaseURL + "/data/cases/#{caseId}/events")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
          .header("Experimental", "true")
          .body(ElFileBody("bodies/multitrackspec/HearingScheduleSubmit.json"))
  ...
  // feed(cpfulltestFeeder)
    exec(_.setAll(
      ...
      /*======================================================================================
                        * Civil Progression - Search Case
      ==========================================================================================*/
      .group("CivilMT_TransferOnline_030_SearchCase") {
        exec(http("CivilMT_TransferOnline_030_SearchCase")
          .get(BaseURL + "/data/internal/cases/#{caseId}")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.ui-case-view.v2+json")
        //  .check(substring("Summary"))
    ...
    ==========================================================================================*/
      .group("CivilMT_TransferOnline_040_TransferOnline") {
        exec(http("CivilMT_TransferOnline_040_005_TransferOnline")
          ...
          .exec(http("CivilMT_TransferOnline_040_010_TransferOnline")
          ...
          .exec(http("CivilMT_TransferOnline_040_015_TransferOnline")
            .get("/workallocation/case/tasks/#{caseId}/event/TRANSFER_ONLINE_CASE/caseType/CIVIL/jurisdiction/CIVIL")
            .headers(CivilDamagesHeader.MoneyClaimNav)
            .header("accept", "application/json")
            .check(substring("task_required_for_event"))
      ...
      /*======================================================================================
             *  *  Civil Progression - '	What hearing notice do you want to create?
  ==========================================================================================*/
      .group("CivilMT_TransferOnline_050_TransferOnlineCase") {
        exec(http("CivilMT_TransferOnline_050_005_TransferOnlineCase")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=TRANSFER_ONLINE_CASETransferOnlineCase")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/TransferOnlineCase.json"))
      ...
      /*======================================================================================
         *  Civil Progression - '	Hearing Schedule Submit
 ==========================================================================================*/
      .group("CivilMT_TransferOnline_070_TransferOnlineSubmit") {
        exec(http("CivilMT_TransferOnline_070_005_TransferOnlineSubmit")
          .post(BaseURL + "/data/cases/#{caseId}/events")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
          .header("Experimental", "true")
          .body(ElFileBody("bodies/multitrackspec/TransferOnlineSubmit.json"))
          .check(substring("confirmation_header"))
        )
          .exec { session =>
            val fw = new BufferedWriter(new FileWriter("HearingScheduled.csv", true))
...
==========================================================================================*/
  val HearingFee =
    ...
    exec(_.setAll(
      ...
      /*======================================================================================
                        * Civil Progression - Search Case
      ==========================================================================================*/
      .group("CivilMT_HearingFee_030_SearchCase") {
          exec(http("CivilMT_HearingFee_030_SearchCase")
      ...
      ==========================================================================================*/
      .group("CivilMT_HearingFee_160_ServiceRequest") {
        exec(http("CivilMT_HearingFee_160_005_ServiceRequest")
  ...
  ==========================================================================================*/
      .group("CivilMT_HearingFee_170_PayNow") {
        exec(http("CivilMT_HearingFee_170_005_PayNow")
...
==========================================================================================*/
      .group("CivilMT_HearingFee_180_CardDetails") {
        exec(http("CivilMT_HearingFee_180_005_CardDetails")
          .post(BaseURL + "/payments/service-request/#{payment_group_reference}/card-payments")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .header("accept", "application/json, text/plain, */*")
          .body(ElFileBody("bodies/CaseProg/PayNowEvent.json"))
  ...
  ==========================================================================================*/
      .group("CivilMT_HearingFee_180_PayUsingPBA") {
        exec(http("CivilMT_HearingFee_180_005_PayUsingPBA")
    ...
    ==========================================================================================*/
      .group("CivilMT_HearingFee_190_ServiceRequestReturn") {
        exec(http("CivilMT_HearingFee_190_005_ServiceRequestReturn")
...
==========================================================================================*/
  ...
  "EvidenceMonth" -> Common.getMonth())
      ...
      /*======================================================================================
                        * Civil Progression - Search Case
      ==========================================================================================*/
      .group("CivilMT_UploadEvidence_030_SearchCase") {
          exec(http("CivilMT_UploadEvidence_030_005_SearchCase")
            .get(BaseURL + "/cases/case-details/#{caseId}")
            .headers(CivilDamagesHeader.MoneyClaimNav))
        // .check(substring("caseFile")))
      }
      ...
      ==========================================================================================*/
      .group("CivilMT_UploadEvidence_040_UploadYourDocs") {
        exec(http("CivilMT_UploadEvidence_040_005_UploadYourDocs")
          .get("/workallocation/case/tasks/#{caseId}/event/EVIDENCE_UPLOAD_APPLICANT/caseType/CIVIL/jurisdiction/CIVIL")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .check(substring("task_required_for_event"))
        )
          .exec(http("CivilMT_UploadEvidence_040_010_UploadYourDocs")
    ...
    ==========================================================================================*/
      .group("CivilMT_UploadEvidence_050_UploadYourDocsContinue") {
        exec(http("CivilMT_UploadEvidence_050_005_UploadYourDocsContinue")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=EVIDENCE_UPLOAD_APPLICANTEvidenceUpload")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/UploadYourDocsContinue.json"))
  ...
  ==========================================================================================*/
      .group("CivilMT_UploadEvidence_060_TypeOfDocument") {
        exec(http("CivilMT_UploadEvidence_060_005_TypeOfDocument")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=EVIDENCE_UPLOAD_APPLICANTDocumentSelectionFastTrack")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/TypeOfDocument.json"))
    ...
    ==========================================================================================*/
      .group("CivilMT_UploadEvidence_070_DisclosureListClaim1") {
        exec(http("CivilMT_UploadEvidence_070_005_DisclosureListClaim1")
      ...
      /*======================================================================================
           *  Civil Progression - Select the type of document
==========================================================================================*/
      .group("CivilMT_UploadEvidence_080_EvidenceUploadClaim") {
        exec(http("CivilMT_UploadEvidence_080_005_EvidenceUploadClaim")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=EVIDENCE_UPLOAD_APPLICANTDocumentUpload")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
          .body(ElFileBody("bodies/multitrackspec/EvidenceUploadClaim.json"))
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_090_UploadDocumentsSubmitClaim") {
        exec(http("CivilMT_UploadEvidence_090_005_UploadDocumentsSubmitClaim")
          .post(BaseURL + "/data/cases/#{caseId}/events")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
          .header("Experimental", "true")
          .body(ElFileBody("bodies/multitrackspec/UploadDocumentsSubmitClaim.json"))
          .check(substring("confirmation_header"))
        )
      }
      .pause(MinThinkTime, MaxThinkTime)
  ...
  val EvidenceUploadDefendant =
    ...
    exec(_.setAll(
     ...
     // "caseId" -> "1697800443682595",
      ...
      ==========================================================================================*/
      .group("CivilMT_UploadEvidence_030_SearchCase") {
          exec(http("CivilMT_UploadEvidence_030_SearchCase")
            .get(BaseURL + "/cases/case-details/#{caseId}")
            .headers(CivilDamagesHeader.MoneyClaimNav))
        // .check(substring("caseFile")))
      }
      ...
      /*======================================================================================
                 *  Civil Progression - 'Upload Your Documents' event
      ==========================================================================================*/
      .group("CivilMT_UploadEvidence_110_UploadYourDocsDefend") {
        exec(http("CivilMT_UploadEvidence_110_005_UploadYourDocsDefend")
          .get("/workallocation/case/tasks/#{caseId}/event/EVIDENCE_UPLOAD_RESPONDENT/caseType/CIVIL/jurisdiction/CIVIL")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .check(substring("task_required_for_event"))
        )

          .exec(http("CivilMT_UploadEvidence_110_010_AddACaseNote")
      ...
      /*======================================================================================
               *  Civil Progression - 'Upload Your Documents' Continue
    ==========================================================================================*/
      .group("CivilMT_UploadEvidence_120_UploadYourDocsContinueDef") {
        exec(http("CivilMT_UploadEvidence_120_005_UploadYourDocsContinueDef")
      ...
      /*======================================================================================
             *  Civil Progression - Select the type of document
  ==========================================================================================*/
      .group("CivilMT_UploadEvidence_130_TypeOfDocumentDef") {
        exec(http("CivilMT_UploadEvidence_130_005_TypeOfDocumentDef")
    ...
    ==========================================================================================*/
      .group("CivilMT_UploadEvidence_140_DisclosureListClaimDef") {
        exec(http("CivilMT_UploadEvidence_140_005_DisclosureListClaimDef")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_141_DisclosureListClaimDef2") {
        exec(http("CivilMT_UploadEvidence_141_005_DisclosureListClaimDef2")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
  ...
  ==========================================================================================*/
      .group("CivilMT_UploadEvidence_142_WitnessStatementDef") {
        exec(http("CivilMT_UploadEvidence_142_005_WitnessStatementDef")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_143_WitnessStatementDef") {
        exec(http("CivilMT_UploadEvidence_143_005_WitnessStatementDef")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_144_ExpertReportDef") {
        exec(http("CivilMT_UploadEvidence_144_005_ExpertReportDef")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_145_ExpertReportDef2") {
        exec(http("CivilMT_UploadEvidence_145_005_ExpertReportDef2")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_146_CaseSummaryDef") {
        exec(http("CivilMT_UploadEvidence_146_005_CaseSummaryDef")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_147_CaseSummaryDef2") {
        exec(http("CivilMT_UploadEvidence_147_005_CaseSummaryDef2")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary5IivMwQhKZGomvfQ")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_148_EvidenceUploadClaimDef") {
        exec(http("CivilMT_UploadEvidence_148_005_EvidenceUploadClaimDef")
...
==========================================================================================*/
      .group("CivilMT_UploadEvidence_150_UploadDocumentsSubmitDef") {
        exec(http("CivilMT_UploadEvidence_080_005UploadDocumentsSubmitDef")
          .post(BaseURL + "/data/cases/#{caseId}/events")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
  ...
  //feed(cpfulltestFeeder)
    exec(_.setAll(
      ...
      /*======================================================================================
                        * Civil Progression - Search Case
      ==========================================================================================*/
      .group("CivilMT_FinalOrders_030_SearchCase") {
        exec(http("CivilMT_FinalOrders_030_005_SearchCase")
          .get(BaseURL + "/data/internal/cases/#{caseId}")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.ui-case-view.v2+json")
          .check(substring("summary")))
      ...
      ==========================================================================================*/
      .group("CivilMT_FinalOrders_040_MakeAnOrder") {
        exec(http("CivilMT_FinalOrders_040_005_MakeAnOrder")
          .get("/workallocation/case/tasks/{caseId}/event/GENERATE_DIRECTIONS_ORDER/caseType/CIVIL/jurisdiction/CIVIL")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .check(substring("task_required_for_event"))
        )
          .exec(http("CivilMT_FinalOrders_040_010_MakeAnOrder")
  ...
  ==========================================================================================*/
      .group("CivilMT_FinalOrders_050_OrderTrackAllocation") {
        exec(http("CivilMT_FinalOrders_050_005_OrderTrackAllocation")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=GENERATE_DIRECTIONS_ORDERTrackAllocation")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/OrderSelection.json"))
  ...
  ==========================================================================================*/
      .group("CivilMT_FinalOrders_060_OrderTemplate") {
        exec(http("CivilMT_FinalOrders_060_005_OrderTemplate")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=GENERATE_DIRECTIONS_ORDERSelectTemplate")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/OrderTemplate.json"))
     ...
     *  Civil Progression - Order Template
  ==========================================================================================*/
      .group("CivilMT_FinalOrders_070_OrderTemplateDownload") {
        exec(http("CivilMT_FinalOrders_070_005_OrderTemplateDownload")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=GENERATE_DIRECTIONS_ORDERDownloadTemplate")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/multitrackspec/OrderTemplateDownload.json"))
...
==========================================================================================*/
      ...
      .group("CivilMT_FinalOrders_080_UploadDraftDirections") {
        exec(http("CivilMT_FinalOrders_080_005_UploadDraftDirections")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          ...
          .formParam("caseTypeId", "CIVIL")
          .formParam("jurisdictionId", "CIVIL")
          .check(jsonPath("$.documents[0].hashToken").saveAs("specmultitrackmakeanorderhashtoken"))
          .check(jsonPath("$.documents[0]._links.self.href").saveAs("specmultitrackmakeanorderdocurl"))
          .check(substring("casesummary.docx")))
      }
      .pause(MinThinkTime, MaxThinkTime)
...
==========================================================================================*/
      ...
      .group("CivilMT_FinalOrders_090_UploadDraftDirectionsSubmit") {
        exec(http("CivilMT_FinalOrders_090_005_UploadDraftDirectionsSubmit")
          .post("/data/case-types/CIVIL/validate?pageId=DEFENDANT_RESPONSEDraftDirections")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/multitrackspec/UploadDraftDirectionMakeAnOrder.json"))
  ...
  ==========================================================================================*/
      .group("CivilMT_FinalOrders_100_FinalOrdersSubmit") {
        exec(http("CivilMT_FinalOrders_100_005_FinalOrdersSubmit")
          .post(BaseURL + "/data/cases/#{caseId}/events")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
          .body(ElFileBody("bodies/multitrackspec/FinalOrdersSubmitMakeAnOrder.json"))
          .check(substring("confirmation_body"))
        )
      }
      .pause(MinThinkTime, MaxThinkTime)
