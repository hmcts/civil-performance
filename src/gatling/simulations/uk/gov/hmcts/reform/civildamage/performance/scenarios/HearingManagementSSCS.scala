...
object HearingManagementSSCS {
  ...
  val RequestHearing =
    ...
    * Request a hearing
    ...
    .group("SSCS_RequestHearing_070_ClickRequestHearing") {

      exec(Common.isAuthenticated)
      
      .exec(http("SSCS_RequestHearing_070_005_ClickRequestHearing")
      ...
      .exec(http("SSCS_RequestHearing_070_010_ClickRequestHearing")
    ...
    * Hearing Requirements - Continue
    ...
    .group("SSCS_RequestHearing_080_Requirements") {

      exec(http("SSCS_RequestHearing_080_005_Requirements")
      ...
      .exec(http("SSCS_RequestHearing_080_010_Requirements")
    ...
    .group("SSCS_RequestHearing_100_HearingStage") {

      exec(http("SSCS_RequestHearing_100_005_HearingStage")
    ...
    ======================================================================================*/
      ...
      .group("SSCS_RequestHearing_110_ParticipantAttend") {

        exec(http("SSCS_RequestHearing_110_005_ParticipantAttend")
...
//        .get("/api/prd/lov/getLovRefData?category=HearingPriority&service=BBA3&isChildRequired=N")
 ...
 //   .pause(MinThinkTime, MaxThinkTime)
    ...
    .doIfOrElse(session => session("hearings-percentage").as[Int] < hearingPercentage) {
      group("SSCS_RequestHearing_150_Unlinked") {

        exec(http("SSCS_RequestHearing_150_005_Unlinked")
      ...
      group("SSCS_RequestHearing_155_Linked") {

        exec(http("SSCS_RequestHearing_155_005_Linked")
          .post("/api/hearings/loadServiceLinkedCases?jurisdictionId=SSCS")
          .headers(Headers.commonHeader)
          .header("accept", "application/json, text/plain, */*")
          .formParam("jurisdictionId", "SSCS")
    ...
    .group("SSCS_RequestHearing_160_AdditionalInstructions") {

      exec(http("SSCS_RequestHearing_160_005_AdditionalInstructions")
        .get("/api/prd/caseFlag/getCaseFlagRefData?serviceId=AAA7")
        .headers(Headers.commonHeader)
        .header("accept", "application/json, text/plain, */*")
        .check(substring("hearingRelevant")))

      .exec(http("SSCS_RequestHearing_160_010_AdditionalInstructions")
        .get("/api/prd/lov/getLovRefData?categoryId=HearingChannel&serviceId=AAA7&isChildRequired=N")
        .headers(Headers.commonHeader)
        .header("accept", "application/json, text/plain, */*")
        .check(substring("HearingChannel")))

      .exec(http("SSCS_RequestHearing_160_015_AdditionalInstructions")
        .get("/api/prd/location/getLocationById?epimms_id=739514")
        .headers(Headers.commonHeader)
        .header("accept", "application/json, text/plain, */*")
        .check(substring("court_address")))
    ...
    .group("SSCS_RequestHearing_170_SubmitRequest") {
      
        exec(http("SSCS_RequestHearing_170_005_SubmitRequest")
