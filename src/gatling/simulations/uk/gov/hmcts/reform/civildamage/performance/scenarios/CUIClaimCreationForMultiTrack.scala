...
object CUIClaimCreationForMultiTrack {
  ...
  exec(_.setAll(
    ...
    "Idempotencynumber" -> Common.getIdempotency())
      ...
      /*======================================================================================
                   *   Civil UI Claim - Initiate Claim For Multi Track on Spec Claim
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_030_CreateCase") {
        exec(http("CivilMT_CreateClaim_030_005_CreateCase")
      ...
      .group("CivilMT_CreateClaim_040_StartCreateCase1") {
        exec(http("CivilMT_CreateClaim_040_005_StartCreateCase1")
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_050_BeforeYouStart") {
        exec(http("CivilMT_CreateClaim_005_BeforeYoustart")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECCheckList")
          .headers(CivilDamagesHeader.headers_163)
          .body(ElFileBody("bodies/multitrackspec/CUICreateClaim-BeforeStart.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      //val claimliability =
      .group("CivilMT_CreateClaim_060_CLAIMEligibility") {
        exec(http("CivilMT_CreateClaim_060_005_Eligibility")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECEligibility")
          .headers(CivilDamagesHeader.headers_163)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-Eligibility.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      //val claimreferences =
      .group("CivilMT_CreateClaim_070_CLAIMReferences") {
        exec(http("CivilMT_CreateClaim_070_005_Reference")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECReferences")
          .headers(CivilDamagesHeader.headers_192)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-References.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_080_CLAIMClaimant") {
        feed(postcodeFeeder)
        .exec(http("CivilMT_CreateClaim_080_005_Claimant")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECClaimant")
          .headers(CivilDamagesHeader.headers_258)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-Claimant.json"))
      ...
      //add another claim
      .group("CivilMT_CreateClaim_090_CLAIMAddAnotherClaimant") {
        exec(http("CivilMT_CreateClaim_090_005_CLAIMAddAnotherClaimant")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECAddAnotherClaimant")
          .headers(CivilDamagesHeader.headers_347)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-AddAnotherClaim.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_100_CLAIMNotifications") {
        exec(http("CivilMT_CreateClaim_100_005_Notifications")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECNotifications")
          .headers(CivilDamagesHeader.headers_295)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-Notifications.json"))
          .check(substring("CREATE_CLAIM_SPECNotifications"))
          .check(status.in(200, 304))
        )
          
          .exec(http("CivilMT_CreateClaim_100_010_CaseShare")
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_110_SolicitorOrganisation") {
        exec(http("CivilMT_CreateClaim_110_005_SolicitorOrganisation")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECClaimantSolicitorOrganisation")
          .headers(CivilDamagesHeader.headers_347)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-Organisation.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_120_SolicitorCorrAddress") {
        exec(http("CivilMT_CreateClaim_120_005_SolicitorCorrAddress")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECspecCorrespondenceAddress")
          .headers(CivilDamagesHeader.headers_347)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-Correspondance.json"))
      ...
      .group("CivilMT_CreateClaim_130_CLAIMDefendant") {
        exec(http("CivilMT_CreateClaim_130_005_Def")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECDefendant")
          .headers(CivilDamagesHeader.headers_394)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-DefDetails.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_140_LegalRepresentation") {
        exec(http("CivilMT_CreateClaim_140_005_Rep")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECLegalRepresentation")
          .headers(CivilDamagesHeader.headers_413)
          .body(ElFileBody("bodies//multitrackspec/CivilCreateClaim-DefRep.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_150_DefendantSolicitorEmail") {
        exec(http("CivilMT_CreateClaim_150_005_SolEmail")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECAddAnotherDefendant")
          .headers(CivilDamagesHeader.headers_491)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-AddAnotherDef.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_160_CLAIMDetails") {
        exec(http("CivilMT_CreateClaim_160_005_Details")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECDetails")
          .headers(CivilDamagesHeader.headers_534)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-claimdetails.json"))//skipped upload
      ...
      .group("CivilMT_CreateClaim_170_Documents") {
        exec(http("CivilMT_CreateClaim_170_005_Docs")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECUploadClaimDocument")
          .headers(CivilDamagesHeader.headers_534)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-ClaimDocs.json"))
      ...
      .group("CivilMT_CreateClaim_180_ClaimTimeline") {
        exec(http("CivilMT_CreateClaim_180_005_ClaimTimeline")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECClaimTimeline")
          .headers(CivilDamagesHeader.headers_534)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-ClaimTimeline.json"))
      ...
      .group("CivilMT_CreateClaim_190_EvidenceList") {
        exec(http("CivilMT_CreateClaim_190_005_EvidenceList")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECEvidenceList")
          .headers(CivilDamagesHeader.headers_534)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-EvidenceList.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_200_CLAIMClaimValue") {
        exec(http("CivilMT_CreateClaim_200_005_ClaimValue")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECClaimAmount")
          .headers(CivilDamagesHeader.headers_595)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-ClaimAmount.json"))
      ...
      /*======================================================================================
             ...
             ==========================================================================================*/
      .group("CivilMT_CreateClaim_210_ClaimAmountDetails") {
        exec(http("CivilMT_CreateClaim_210_005_ClaimAmountDetails")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECClaimAmountDetails")
          .headers(CivilDamagesHeader.headers_595)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-ClaimAmountDetails.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_220_ClaimInterest") {
        exec(http("CivilMT_CreateClaim_220_005_ClaimInterest")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECClaimInterest")
          .headers(CivilDamagesHeader.headers_595)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-ClaimInterest.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_230_CLAIMClaimInterestSummery") {
        exec(http("CivilMT_CreateClaim_230_005_CLAIMClaimInterestSummary")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECInterestSummary")
          .headers(CivilDamagesHeader.headers_595)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-ClaimInterestSummary.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_240_CLAIMPbaNumber") {
        exec(http("CivilMT_CreateClaim_240_005_PBANumber")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECPbaNumber")
          .headers(CivilDamagesHeader.headers_610)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-PbaNumber.json"))
    ...
    /*======================================================================================
                 * Civil UI Claim - Fixed commencement  costs
      ==========================================================================================*/
    .group("CivilMT_CreateClaim_250_FCC") {
      exec(http("CivilMT_CreateClaim_250_005_FCC")
        .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECFixedCommencementCosts")
        .headers(CivilDamagesHeader.headers_610)
        .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-FCC.json"))
        .check(substring("SPECFixedCommencementCosts"))
        .check(status.in(200, 304))
      )
    }
    .pause(MinThinkTime, MaxThinkTime)
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_260_StatementOfTruth") {
        exec(http("CivilMT_CreateClaim_260_005_SOT")
          .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIM_SPECStatementOfTruth")
          .headers(CivilDamagesHeader.headers_650)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-SOT.json"))
          .check(substring("CREATE_CLAIM_SPECStatementOfTruth"))
          .check(status.in(200, 304))
        )
          .exec(http("CivilMT_CreateClaim_260_010_CaseShareOrgs")
            .get("/api/caseshare/orgs")
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_270_SubmitClaim") {
        
        exec(http("CivilMT_CreateClaim_270_005_Submit")
        ...
        //  .headers(CivilDamagesHeader.MoneyClaimSubmitHeader)
          ...
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-Submit.json"))
      ...
      /*======================================================================================
        ...
        ==========================================================================================*/
      .group("CivilMT_CreateClaim_280_BackToCaseDetailsPage") {
        exec(http("CivilMT_CreateClaim_280_005_CaseDetails")
          .get("/data/internal/cases/${caseId}")
          .headers(CivilDamagesHeader.headers_717)
          .check(status.in(200, 201,204,304))
        )
          .exec(http("CivilMT_CreateClaim_280_010_CaseDetails2")
            .post("/api/role-access/roles/manageLabellingRoleAssignment/${caseId}")
            .headers(CivilDamagesHeader.headers_717)
            .body(ElFileBody("bodies/multitrackspec/CivilAccessClaim-RollAccess.json"))
            .check(status.in(200, 201,204, 304))
          )
          .exec(http("CivilMT_CreateClaim_280_015_CaseDetails3")
  ...
  // payment pba fee payment
    .group("CivilMT_CreateClaim_290_ServiceRequestForPay") {
      exec(http("CivilMT_CreateClaim_290_005_ServiceRequestToPay")
      ...
      .group("CivilMT_CreateClaim_300_ClickOnPay") {
        exec(http("CivilMT_CreateClaim_300_005_ClickOnPay")
        ...
        /*  .exec(http("CivilMT_CreateClaim_290_010_Paycases")
      ...
      //choose PBA Payments
      .group("CivilMT_CreateClaim_310_ChoosePBAPayments") {
        exec(http("CivilMT_CreateGA_310_005_ChoosePBAPayments")
      ...
      .group("CivilMT_CreateClaim_320_FinalPayment") {
        exec(http("CivilMT_CreateGA_320_005_FinalPay")
          .post("/payments/service-request/#{serviceRef}/pba-payments")
          .headers(Headers.commonHeader)
          .body(ElFileBody("bodies/multitrackspec/CivilCreateClaim-PBAPayment.json"))
      ...
      .pause(50)
        ...
        .exec { session =>
          val fw = new BufferedWriter(new FileWriter("XUISpecClaimsMultitrack.csv", true))
          try {
