  ...
  val claimresponsetype =
    group ("CD_ClaimantResponse_40_RespondentResponse") {
      exec(http("CD_ClaimantResponse_40_Response")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSERespondentResponse")
        .headers(CivilDamagesHeader.headers_1604)
        .body(StringBody("{\"data\":{\"respondent1ClaimResponseType\":\"FULL_DEFENCE\",\"respondent1ClaimResponseDocument\":{\"file\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}\",\"document_filename\":\"1MB-c.pdf\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}/binary\"}},\"applicant1ProceedWithClaim\":\"Yes\",\"allocatedTrack\":\"MULTI_CLAIM\",\"claimType\":\"CLINICAL_NEGLIGENCE\"},\"event\":{\"id\":\"CLAIMANT_RESPONSE\",\"summary\":\"\",\"description\":\"\"},\"event_data\":{\"respondent1ClaimResponseType\":\"FULL_DEFENCE\",\"respondent1ClaimResponseDocument\":{\"file\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}\",\"document_filename\":\"1MB-c.pdf\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}/binary\"}},\"applicant1ProceedWithClaim\":\"Yes\",\"allocatedTrack\":\"MULTI_CLAIM\",\"claimType\":\"CLINICAL_NEGLIGENCE\"},\"event_token\":\"${event_token_claimantresponse}\",\"ignore_warning\":false,\"case_reference\":\"${caseId}\"}"))
        .check(status.in(200, 304))
      )
    }
      .pause (MinThinkTime, MaxThinkTime)
  ...
  val claimresponsedocument =
    group ("CD_ClaimantResponse_50_ResponseDocument") {
      exec(http("CD_ClaimantResponse_50_Document")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEApplicantDefenceResponseDocument")
  ...
  val claimantresponsefiledirectoryquestionaire =
    group ("CD_ClaimantResponse_60_DirectionsQuestionnaire") {
      exec(http("CD_ClaimantResponse_60_Questionaire")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEFileDirectionsQuestionnaire")
  ...
  val claimdisclosureofelectronicsdoc =
    group ("CD_ClaimantResponse_70_ElectronicDocuments") {
      exec(http("CD_ClaimantResponse_70_document")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEDisclosureOfElectronicDocuments")
  ...
  val claiantdisclosureofnonelectronicsdoc =
    group ("CD_ClaimantResponse_80_NonElectronicDocuments") {
      exec(http("CD_ClaimantResponse_80_documents")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEDisclosureOfNonElectronicDocuments")
  ...
  val claimantresponsedisclosurereport =
    group ("CD_ClaimantResponse_90_DisclosureReport") {
      exec(http("CD_ClaimantResponse_90_disclosure")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEDisclosureReport")
  ...
  val clamantdefresponseexpert =
    group ("CD_ClaimantResponse_100_RESPONSEExperts") {
      exec(http("CD_ClaimantResponse_100_Experts")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEExperts")
  ...
  val claimantdefresponsewitness =
    group ("CD_ClaimantResponse_110_RESPONSEWitnesses") {
      exec(http("CD_ClaimantResponse_110_Witness")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEWitnesses")
  ...
  val claimantdefresponselanguage =
    group ("CD_ClaimantResponse_120_RESPONSELanguage") {
      exec(http("CD_ClaimantResponse_120_Language")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSELanguage")
  ...
  val claimantdefresponsehearing =
    group ("CD_ClaimantResponse_130_RESPONSEHearing") {
      exec(http("CD_ClaimantResponse_130_Hearing")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEHearing")
  ...
  val claimantdefresponsedraftdirections =
    group ("CD_ClaimantResponse_150_RESPONSEDraftDirections") {
      exec(http("CD_ClaimantResponse_150_Directions")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEDraftDirections")
        .headers(CivilDamagesHeader.headers_1885)
        .body(StringBody("{\"data\":{\"applicant1DQDraftDirections\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${DocumentIDForClaimResponse}\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${DocumentIDForClaimResponse}/binary\",\"document_filename\":\"2MB.pdf\"}},\"event\":{\"id\":\"CLAIMANT_RESPONSE\",\"summary\":\"\",\"description\":\"\"},\"event_data\":{\"respondent1ClaimResponseType\":\"FULL_DEFENCE\",\"respondent1ClaimResponseDocument\":{\"file\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}\",\"document_filename\":\"1MB-c.pdf\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}/binary\"}},\"applicant1ProceedWithClaim\":\"Yes\",\"allocatedTrack\":\"MULTI_CLAIM\",\"claimType\":\"CLINICAL_NEGLIGENCE\",\"applicant1DefenceResponseDocument\":{},\"applicant1DQFileDirectionsQuestionnaire\":{\"oneMonthStayRequested\":\"No\",\"reactionProtocolCompliedWith\":\"Yes\",\"explainedToClient\":[\"CONFIRM\"]},\"applicant1DQDisclosureOfElectronicDocuments\":{\"reachedAgreement\":\"Yes\"},\"applicant1DQDisclosureOfNonElectronicDocuments\":{\"directionsForDisclosureProposed\":\"Yes\",\"standardDirectionsRequired\":\"Yes\",\"bespokeDirections\":null},\"applicant1DQDisclosureReport\":{\"disclosureFormFiledAndServed\":\"Yes\",\"disclosureProposalAgreed\":\"No\",\"draftOrderNumber\":null},\"applicant1DQExperts\":{\"expertRequired\":\"No\",\"details\":[]},\"applicant1DQWitnesses\":{\"witnessesToAppear\":\"No\",\"details\":[]},\"applicant1DQLanguage\":{\"evidence\":\"ENGLISH\",\"court\":\"ENGLISH\",\"documents\":\"ENGLISH\"},\"applicant1DQHearing\":{\"hearingLength\":\"ONE_DAY\",\"unavailableDatesRequired\":\"No\",\"unavailableDates\":[]},\"applicant1DQDraftDirections\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${DocumentIDForClaimResponse}\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${DocumentIDForClaimResponse}/binary\",\"document_filename\":\"2MB.pdf\"}},\"event_token\":\"${event_token_claimantresponse}\",\"ignore_warning\":false,\"case_reference\":\"${caseId}\"}"))
        .check(status.in(200, 304))
      )
    }
      .pause (MinThinkTime, MaxThinkTime)
  ...
  val claimantresponsefurtherinformation =
    group ("CD_ClaimantResponse_170_FurtherInformation") {
      exec(http("CD_ClaimantResponse_170_Info")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEFurtherInformation")
  ...
  val claimantdefresponsestatementoftruth =
    group ("CD_ClaimantResponse_180_StatementOfTruth") {
      exec(http("CD_ClaimantResponse_180_005_ST")
        .post("/data/case-types/UNSPECIFIED_CLAIMS/validate?pageId=CLAIMANT_RESPONSEStatementOfTruth")
  ...
  val claimantafterdefresponsesearchforcompletable =
    group ("CD_ClaimantResponse_200_backtoCaseFromClaimResponse") {
      exec(http("CD_ClaimantResponse_200_005_casedetails")
        ...
        .body(StringBody("{\"searchRequest\":{\"ccdId\":\"${caseId}\",\"eventId\":\"CLAIMANT_RESPONSE\",\"jurisdiction\":\"CIVIL\",\"caseTypeId\":\"UNSPECIFIED_CLAIMS\"}}"))
        .check(status.is(401))
      )
