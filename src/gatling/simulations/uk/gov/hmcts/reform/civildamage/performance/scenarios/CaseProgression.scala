    ...
    exec(_.setAll(
      ...
      .group("CivilCaseProg_BundleCreation_350_BundleAPI") {
        exec(http("CivilCaseProg_BundleCreation_040_005_BundleAPI")
          ...
          .header("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJraWQiOiI4cDJpajg2S0pTeENKeGcveUovV2w3TjcxMXM9IiwiYWxnIjoiUlMyNTYifQ..al0RP6pDRYsdEiBTGxYN3A8FfNqCAmuA2nlrzu-TrtnEDf1eQXl14PXkSgoRzJLYqf81QydKwTQdPbtqmZMvuBzU8xhIQPVgSUY5omBxCSLGliMgxouQE67-V7pxW-CB-BbpcjRkWfWxRk68LnMX8JnPhhe9OAIa0hTtyQ6iGNbhuXfGKWdcJ9k5zKsO5b6hkjAJ-Q8Tfij3tMplpIbF60qRMqYlUF-XE6CWE_04PENP0V0lEKZ2z357qr3YB5eW6G4j6TtrG5ZUvqWskudRESrUZVA4GYX1jYlLYHK5NFodjbo921vjqexPGQiYY7YfgGy9L1nrWbv2W8FPbN0feA")
          .header("Content-Type", "application/json")
          .header("Accept", "*/*")
          .check(status.in(200, 201))
        )
