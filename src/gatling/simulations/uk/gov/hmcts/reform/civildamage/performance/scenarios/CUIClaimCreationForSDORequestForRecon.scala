...
object CUIClaimCreationForSDORequestForRecon {
  ...
  exec(_.setAll(
    ...
    .group("CUI_CreateClaim_140_SolOrganisation") {
      exec(http("CUI_CreateClaim_140_005_SolOrganisation")
        ...
        .headers(CivilDamagesHeader.headers_413)
        .body(ElFileBody("bodies/cuiclaim/CivilCreateClaim-DefOrganisation.json"))
    ...
    .group("CUI_CreateClaim_100_CLAIMNotifications") {
      exec(http("CUI_CreateClaim_100_005_DefNotifications")
        ...
        .headers(CivilDamagesHeader.headers_295)
        .body(ElFileBody("bodies/cuiclaim/CivilCreateClaim-DefNotifications.json"))
    ...
    .pause(MinThinkTime, MaxThinkTime)
        ...
        .group("CUI_CreateClaim_100_DefCorrespondanceAddress") {
          exec(http("CUI_CreateClaim_100_005_DefCorrespondanceAddress")
            ...
            .headers(CivilDamagesHeader.headers_295)
            .body(ElFileBody("bodies/cuiclaim/CivilCreateClaim-DefCorrespondanceAddress.json"))
      ...
      .pause(MinThinkTime, MaxThinkTime)
            ...
            .group("CUI_CreateClaim_150_IsAirlineClaim") {
              exec(http("CUI_CreateClaim_150_005_Is AirlineClaim")
                ...
                .headers(CivilDamagesHeader.headers_491)
                .body(ElFileBody("bodies/cuiclaim/CivilCreateClaim-FlightClaim.json"))
