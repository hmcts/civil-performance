...
object UnspecIntermediateTrack {
  ...
  val run=
    ...
    /*=========================================================================================
                 * Create UnSpec Civil Claim For  - Start the case
    ==========================================================================================*/
    
    .group("CivilIT_CreateClaim_040_StartCreateCase1") {
      exec(http("CivilIT_CreateClaim_040_StartCreateCase1")
    ...
    /*======================================================================================
      ...
      ==========================================================================================*/
    .group("CivilIT_CreateClaim_050_CLAIMEligibility") {
      exec(http("CivilIT_CreateClaim_050_Eligibility")
        .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIMEligibility")
        .headers(CivilDamagesHeader.headers_163)
        .body(ElFileBody("bodies/intermediateunspec/0013_request.json"))
    ...
    .group("CivilIT_CreateClaim_060_CLAIMDefendantSolicitorEmail") {
      exec(http("CivilIT_CreateClaim_060_SolEmail")
        .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIMDefendantSolicitorEmail")
        .headers(CivilDamagesHeader.headers_491)
        .body(ElFileBody("bodies/intermediateunspec/0076_request.json"))
    ...
    .group("CivilIT_CreateClaim_070_CLAIMPbaNumber") {
      exec(http("CivilIT_CreateClaim_070_PBANumber")
        .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIMPbaNumber")
        .headers(CivilDamagesHeader.headers_610)
        .body(ElFileBody("bodies/intermediateunspec/0104_request.json"))
    ...
    .group("CivilIT_CreateClaim_080_CLAIMStatementOfTruth") {
      exec(http("CivilIT_CreateClaim_080_SOT")
        .post("/data/case-types/CIVIL/validate?pageId=CREATE_CLAIMStatementOfTruth")
        .headers(CivilDamagesHeader.headers_650)
        .body(ElFileBody("bodies/intermediateunspec/0108_request.json"))
    ...
    .group("CivilIT_CreateClaim_090_SubmitClaim") {

      exec(http("CivilIT_CreateClaim_090_005_Submit")
        .post("/data/case-types/CIVIL/cases?ignore-warning=false")
        .headers(CivilDamagesHeader.headers_672)
        .body(ElFileBody("bodies/intermediateunspec/0112_request.json"))
    ...
    .group("CivilIT_CreateClaim_100_BackToCaseDetailsPage") {
      exec(http("CivilIT_CreateClaim_100_005_CaseDetails")
  ...
  val UnSpecClaimUpdateWithSubmittedDate =
    ...
    /*======================================================================================
      ...
      ==========================================================================================*/
    // payment fee
    group("CivilIT_CreateClaim_110_ClickPay") {
      exec(http("CivilIT_CreateClaim_110_005_ClickPay")
    ...
    .group("CivilIT_CreateClaim_120_PaymentGroups") {
      exec(http("CivilIT_CreateClaim_120_005_SelectPayGroups")
        .get("/payments/cases/#{caseId}/paymentgroups")
        .headers(CivilDamagesHeader.headers_717)
        .check(status.in(200, 304))
      )
        .exec(http("CivilIT_CreateClaim_120_010_PaymentOrder")
    ...
    .group("CivilIT_CreateClaim_130_PBAAccounts") {
      exec(http("CivilIT_CreateClaim_130_005_SelectPBA")
    ...
    .group("CivilIT_CreateClaim_140_SubmitPayment") {
      exec(http("CivilIT_CreateClaim_140_005_SubmitPayment")
        .post("/payments/service-request/#{serviceRef}/pba-payments")
        .headers(CivilDamagesHeader.headers_650)
        .body(ElFileBody("bodies/intermediateunspec/0137_request.json"))
    ...
    group("CivilIT_CreateClaim_150_NotifyClaimEvent") {
      exec(http("CivilIT_CreateClaim_150_005_Notify")
      ...
      .exec(http("CivilIT_CreateClaim_150_010_Notify")
    ...
    .group("CD_CreateClaim_200_NotifyDetailsEventSubmit") {
      exec(http("CD_CreateClaim_200_EventSubmit")
        ...
        .body(ElFileBody("bodies/intermediateunspec/0214_request.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_040_RespondDefDetails") {
        exec(http("CivilIT_DefResponse_040_005_RespondDefDetails")
          ...
          .body(ElFileBody("bodies/intermediateunspec/RespondDefDetails.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_050_RespondDefChoice") {
        exec(http("CivilIT_DefResponse_050_005_RespondDefChoice")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/RespondDefChoice.json"))
          .check(substring("RESPONDENTSOLICITORONE"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_060_YourFileReference") {
        exec(http("CivilIT_DefResponse_060_005_YourFileReference")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/YourFileReference.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_080_UploadDefenceSubmit") {
        exec(http("CivilIT_DefResponse_080_005_UploadDefenceSubmit")
          ...
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/UploadDefence.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_090_FileDirectionsQuestionnaire") {
        exec(http("CivilIT_DefResponse_090_005_FileDirectionsQuestionnaire")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/FileDirectionsQuestionnaire.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_100_FixedRecoverableCosts") {
        exec(http("CivilIT_DefResponse_100_005_FixedRecoverableCosts")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/FixedRecoverableCosts.json"))
    ...
    ==========================================================================================*/
          ...
          .group("CivilIT_DefResponse_110_DisclosureElectDocuments") {
            exec(http("CivilIT_DefResponse_110_005_DisclosureElectDocuments")
              ...
              .headers(CivilDamagesHeader.MoneyClaimPostHeader)
              .header("x-xsrf-token", "#{XSRFToken}")
              .body(ElFileBody("bodies/intermediateunspec/DisclosureElectDocuments.json"))
              .check(substring("respondent1DQDisclosureOfElectronicDocuments"))
            )
          }
          .pause(MinThinkTime, MaxThinkTime)
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_120_DisclosureNonElectDocuments") {
        exec(http("CivilIT_DefResponse_120_005_DisclosureNonElectDocuments")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/DisclosureNonElectDocuments.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_130_UseAnExpert") {
        exec(http("CivilIT_DefResponse_130_005_UseAnExpert")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/UseAnExpert.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_140_AnyWitnesses") {
        exec(http("CivilIT_DefResponse_140_005_AnyWitnesses")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/WitnessesToAppear.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_150_WelshLanguage") {
        exec(http("CivilIT_DefResponse_150_005_WelshLanguage")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/WelshLanguage.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_160_HearingAvailability") {
        exec(http("CivilIT_DefResponse_160_005_HearingAvailability")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/HearingAvailability.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_180_UploadDraftDirectionsSubmit") {
        exec(http("CivilIT_DefResponse_180_005_UploadDraftDirectionsSubmit")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/UploadDraftDirections.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_190_CourtLocationCode") {
        exec(http("CivilIT_DefResponse_190_005_CourtLocationCode")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/ResCourtLocationCode.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_200_SupportAccessNeeds") {
        exec(http("CivilIT_DefResponse_200_005_SupportAccessNeeds")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/SupportAccessNeeds.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_210_VulnerabilityQuestions") {
        exec(http("CivilIT_DefResponse_210_005_VulnerabilityQuestions")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/VulnerabilityQuestions.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_220_AnyFutureApplications") {
        exec(http("CivilIT_DefResponse_220_005_AnyFutureApplications")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/AnyFutureApplications.json"))
...
==========================================================================================*/
      ...
      .group("CivilIT_DefResponse_230_RespondToClaimSoT") {
        exec(http("CivilIT_DefResponse_230_005_RespondToClaimSoT")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/RespondToClaimSoT.json"))
...
==========================================================================================*/
  ...
  val RespondToDefence =
    ...
    ==========================================================================================*/
      // val returntocasedetailsafternotifydetails =
      .group("CivilIT_ClaimIntent_030_RespondToDefence") {
        exec(http("XUI_CreateClaim_030_005_RespondToDefence")
          .get("/workallocation/case/tasks/#{caseId}/event/CLAIMANT_RESPONSE/caseType/CIVIL/jurisdiction/CIVIL")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .check(substring("task_required_for_event"))
        )
          .exec(http("CivilIT_ClaimIntent_030_010_RespondToDefence")
            ...
            .check(jsonPath("$.case_fields[1].value.partyName").saveAs("partyName"))
            .check(jsonPath("$.case_fields[1].value.partyName").saveAs("defPartyName"))
            .check(jsonPath("$..formatted_value.file.document_url").saveAs("document_url"))
            .check(jsonPath("$.event_token").saveAs("event_token"))
          )
        .exec(http("CivilIT_ClaimIntent_030_015_RespondToDefence")
          .get("/workallocation/case/tasks/#{caseId}/event/CLAIMANT_RESPONSE/caseType/CIVIL/jurisdiction/CIVIL")
          .headers(CivilDamagesHeader.MoneyClaimNav)
          .check(substring("task_required_for_event"))
        )
      ...
      /*======================================================================================
  * Create Civil Claim - View and respond to defence - want to proceed with claim
  ==========================================================================================*/

      .group("CivilIT_ClaimIntent_040_ViewAndRespond") {
        exec(http("CivilIT_ClaimIntent_040_005_ViewAndRespond")
          .post(BaseURL + "/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSERespondentResponse")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("x-xsrf-token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/ViewAndRespond.json"))
  ...
  * Create Civil Claim - Upload Response To Defence
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_050_UploadResponseToDefence") {
        exec(http("CivilIT_ClaimIntent_050_005_UploadResponseToDefence")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary3qhEjdcm5ZAK4s7o")
  ...
  * Create Civil Claim - View and respond to defence Submit
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_060_UploadResponseToDefSubmit") {
        exec(http("CivilIT_ClaimantIntent_060_005_UploadResponseToDefSubmit")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEApplicantDefenceResponseDocument")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/UploadResponseToDef.json"))
  ...
  * Create Civil Claim - File directions questionnaire
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_070_FileDirectionsQuestionnaireDef") {
        exec(http("CivilIT_ClaimantIntent_070_005_FileDirectionsQuestionnaireDef")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEFileDirectionsQuestionnaire")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/FileDirectionsQuestionnaireClaim.json"))
  ...
  * Create Civil Claim -Fixed Recoverable Costs
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_080_FixedRecoverableCosts") {
        exec(http("CivilIT_ClaimantIntent_080_005_FixedRecoverableCosts")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEFixedRecoverableCosts")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/FixedRecoverableCostsDef.json"))
      ...
      .pause(MinThinkTime, MaxThinkTime)
        ...
        /*======================================================================================
    * Create Civil Claim -Do you want to propose directions for disclosure for electronics
    ==========================================================================================*/
  
        .group("CivilIT_ClaimantIntent_090_ProposeDirectionsForDisclosure") {
          exec(http("CivilIT_ClaimantIntent_090_005_ProposeDirectionsForDisclosure")
            .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEDisclosureOfElectronicDocuments")
            .headers(CivilDamagesHeader.MoneyClaimPostHeader)
            .body(ElFileBody("bodies/intermediateunspec/ProposeDirectionsForDisclosureElectronics.json"))
            .check(substring("applicant1DQDisclosureOfElectronicDocuments"))
          )
        }
        .pause(MinThinkTime, MaxThinkTime)
  ...
  * Create Civil Claim -Do you want to propose directions for disclosure?
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_100_ProposeDirectionsForDisclosure") {
        exec(http("CivilIT_ClaimantIntent_100_005_ProposeDirectionsForDisclosure")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEDisclosureOfNonElectronicDocuments")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/ProposeDirectionsForDisclosure.json"))
  ...
  * Create Civil Claim -Do you want to propose directions for disclosure?
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_110_UseExpertClaim") {
        exec(http("CivilIT_ClaimantIntent_110_005_UseExpertClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEExperts")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/UseExpertClaim.json"))
  ...
  * Create Civil Claim -Are there any witnesses who should attend the hearing?
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_120_AnyWitnessesClaim") {
        exec(http("CivilIT_ClaimantIntent_120_005_AnyWitnessesClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEWitnesses")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/AnyWitnessesClaim.json"))
  ...
  * Create Civil Claim -Welsh language
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_130_WelshLanguageClaim") {
        exec(http("CivilIT_ClaimantIntent_130_005_WelshLanguageClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSELanguage")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/WelshLanguageClaim.json"))
  ...
  * Create Civil Claim -Hearing availability
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_140_HearingAvailabilityClaim") {
        exec(http("CivilIT_ClaimantIntent_140_HearingAvailabilityClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEHearing")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/HearingAvailabilityClaim.json"))
  ...
  * Create Civil Claim -Upload draft directions
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_150_UploadDraftDirectionsClaim") {
        exec(http("CivilIT_ClaimantIntent_150_005_UploadDraftDirectionsClaim")
          .post(BaseURL + "/documentsv2")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/json, text/plain, */*")
          .header("content-type", "multipart/form-data; boundary=----WebKitFormBoundary3qhEjdcm5ZAK4s7o")
  ...
  * Create Civil Claim -Hearing availability
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_160_UploadDirectionsClaimSubmit") {
        exec(http("CivilIT_ClaimantIntent_160_005_UploadDirectionsClaimSubmit")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEDraftDirections")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/UploadDirectionsClaimSubmit.json"))
  ...
  * Create Civil Claim -Does anyone require support for a court hearing?
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_170_RequireSupportClaim") {
        exec(http("CivilIT_ClaimantIntent_170_005_RequireSupportClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEHearingSupport")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/RequireSupportClaim.json"))
  ...
  * Create Civil Claim -Vulnerability Questions
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_180_VulnerabilityQuestionsClaim") {
        exec(http("CivilIT_ClaimantIntent_180_005_VulnerabilityQuestionsClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEVulnerabilityQuestions")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/VulnerabilityQuestionsClaim.json"))
  ...
  * Create Civil Claim -Further information
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_190_FurtherInformationClaim") {
        exec(http("CivilIT_ClaimantIntent_190_005_FurtherInformationClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEFurtherInformation")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/FurtherInformationClaim.json"))
  ...
  * Create Civil Claim -Statement of Truth
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_200_SoTClaim") {
        exec(http("CivilIT_ClaimantIntent_220_005_SoTClaim")
          .post("/data/case-types/CIVIL/validate?pageId=CLAIMANT_RESPONSEStatementOfTruth")
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .body(ElFileBody("bodies/intermediateunspec/SoTClaim.json"))
  ...
  * Create Civil Claim -View and respond to defence submit
  ==========================================================================================*/
      ...
      .group("CivilIT_ClaimantIntent_210_ViewRespondToDefenceSubmit") {
        exec(http("CivilIT_ClaimantIntent_210_005_ViewRespondToDefenceSubmit")
          .post(BaseURL + "/data/cases/#{caseId}/events")
          .headers(CivilDamagesHeader.MoneyClaimDefPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/intermediateunspec/ViewRespondToDefenceSubmit.json"))
  ...
  val SDO =
    ...
    group("CivilIT_CreateClaim_330_BackToCaseDetailsPage") {
      ...
      exec(_.setAll(
        ...
        .exec(http("CivilIT_CreateClaim_330_005_CaseDetails")
...
==========================================================================================*/
      ...
      .group("XUI_CreateClaim_840_SDOdetails") {
        exec(http("XUI_CreateClaim_840_005_SDOdetails")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/intermediateunspec/SDOdetails.json"))
...
==========================================================================================*/
      ...
      .group("XUI_CreateClaim_850_SDOContinue") {
        exec(http("XUI_CreateClaim_850_005_SDOContinue")
          ...
          .headers(CivilDamagesHeader.MoneyClaimPostHeader)
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-data-validate.v2+json;charset=UTF-8")
          .body(ElFileBody("bodies/intermediateunspec/SDOContinue.json"))
...
==========================================================================================*/
      ...
      .group("XUI_CreateClaim_860_SDOSubmit") {
        exec(http("XUI_CreateClaim_860_005_SDOSubmit")
          ...
          .header("accept", "application/vnd.uk.gov.hmcts.ccd-data-store-api.create-event.v2+json;charset=UTF-8")
          .header("X-Xsrf-Token", "#{XSRFToken}")
          .body(ElFileBody("bodies/intermediateunspec/SDOSubmit.json"))
