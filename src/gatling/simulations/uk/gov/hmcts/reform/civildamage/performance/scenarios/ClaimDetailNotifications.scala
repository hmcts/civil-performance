  ...
  def run(implicit postHeaders: Map[String, String]): ChainBuilder = {
    ...
    // val notifyclaimdetailsupload =
      ...
      exec(http("CD_CreateClaim_360_005_upload")
        ...
        .body(StringBody("{\"data\":{\"servedDocumentFiles\":{\"particularsOfClaimText\":null,\"particularsOfClaimDocumentNew\":[{\"id\":\"51cf303d-2fb1-4b7d-a297-08bbdbe7d0ac\",\"value\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}/binary\",\"document_filename\":\"3MB.pdf\"}}],\"medicalReport\":[],\"scheduleOfLoss\":[],\"certificateOfSuitability\":[]}},\"event\":{\"id\":\"NOTIFY_DEFENDANT_OF_CLAIM_DETAILS\",\"summary\":\"\",\"description\":\"\"},\"event_data\":{\"servedDocumentFiles\":{\"particularsOfClaimText\":null,\"particularsOfClaimDocumentNew\":[{\"id\":\"51cf303d-2fb1-4b7d-a297-08bbdbe7d0ac\",\"value\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}/binary\",\"document_filename\":\"3MB.pdf\"}}],\"medicalReport\":[],\"scheduleOfLoss\":[],\"certificateOfSuitability\":[]}},\"event_token\":\"${event_token_notifyclaimdetail}\",\"ignore_warning\":false,\"case_reference\":\"${caseId}\"}"))
        .check(status.in(200, 304))
      )
    ...
    // val notifyclaimdetailseventsubmit=
      ...
      exec(http("CD_CreateClaim_370_EventSubmit")
        ...
        .body(StringBody("{\"data\":{\"servedDocumentFiles\":{\"particularsOfClaimText\":null,\"particularsOfClaimDocumentNew\":[{\"id\":\"51cf303d-2fb1-4b7d-a297-08bbdbe7d0ac\",\"value\":{\"document_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}\",\"document_binary_url\":\"http://dm-store-perftest.service.core-compute-perftest.internal/documents/${Document_ID}/binary\",\"document_filename\":\"3MB.pdf\"}}],\"medicalReport\":[],\"scheduleOfLoss\":[],\"certificateOfSuitability\":[],\"other\":[]}},\"event\":{\"id\":\"NOTIFY_DEFENDANT_OF_CLAIM_DETAILS\",\"summary\":\"\",\"description\":\"\"},\"event_token\":\"${event_token_notifyclaimdetail}\",\"ignore_warning\":false}"))
