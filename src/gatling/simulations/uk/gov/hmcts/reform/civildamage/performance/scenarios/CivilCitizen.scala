...
import uk.gov.hmcts.reform.civildamage.performance.utils.{SpecilTribHeader, Common, Environment, CsrfCheck}
...
object CivilCitizen {
  ...
  //val Citizen =
    ...
    //    .post("https://idam-web-public.perftest.platform.hmcts.net/login?client_id=sptribs-frontend&response_type=code&redirect_uri=https://sptribs-frontend.perftest.platform.hmcts.net/receiver")
        .headers(SpecilTribHeader.CivilCitizenPost)
        .formParam("username", "#{citizenUser}")
...
==========================================================================================*/
      .group("Civil_Citizen_070_RepLegallyQualified?") {
        exec(http("Civil_Citizen_070_005_RepLegallyQualified")
          ...
          .formParam("saveAndContinue", "true")
          .check(substring("representative-details")))
      }
      .pause(MinThinkTime, MaxThinkTime)
...
==========================================================================================*/
      ...
      .headers(SpecilTribHeader.CitizenSTUpload)
